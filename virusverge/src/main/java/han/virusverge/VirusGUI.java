...
/**
 *De GUI class bevat alle graphische output van dit programma
 * 
 * @author Mark
 */
public class VirusGUI {
    ...
    /**
     *Functie voor het opzetten en vullen vaan het frame
     */
    public VirusGUI() {
		...
		txtURL.setText("ftp://ftp.genome.jp/pub/db/virushostdb/virushostdb.tsv");
    ...
    /**
     *
     * @return door de gebruiker ingevoerde URL uit het tekstavak
     */
    ...
    /**
     *
     * @return de keuze voor de classificatie van de gebruiker
     */
    ...
    /**
     *
     * @return boolean true = geselecteerd false = niet geselecteerd
     */
    ...
    * 
    * @param Hosts  bevat een lijst ban hosst id's
    * @param hostsnamen bevat een hashmap met host id's gekoppeld met de namen van de virussen 
    */
    void setkeuze_HOST_ID(ArrayList<Integer> Hosts, HashMap<Integer,String> hostsnamen) {
		cbxHost1.removeAllItems();
		cbxHost2.removeAllItems();
		for(int i = 0; i < Hosts.size(); i++) {
			cbxHost1.addItem(Hosts.get(i).toString()+"("+hostsnamen.get(Hosts.get(i))+")");
			cbxHost2.addItem(Hosts.get(i).toString()+"("+hostsnamen.get(Hosts.get(i))+")");
		}
	}
     ...
     * 
     * @param virusesHost1 Lijst met virussen die overeenkomen van gekozen Host 1
     * @param virusesHost2 Lijst met virussen die overeenkomen van gekozen Host 2
     * @param virusesRes Lijst met virussen die in viruseshost1 én in viruseshost 2 zitten
     */
